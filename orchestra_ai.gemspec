...
Gem::Specification.new do |spec|
  ...
  spec.description = 'Orchestrate multiple AI agents (OpenAI, Gemini, Claude) with role-based execution, parallel processing, task difficulty scoring, and cost optimisation.'
